# Available .MEMORIAL One-Word Domains (9,861)
...
Daily-updated dataset of available and resale .memorial one-word domains from Unique Domains.
...
- `memorial.csv` — public CSV extract (9,861 rows)
- `memorial.json` — public JSON extract (9,861 rows)
...
| big.memorial      | available | $64.98    | —             | 88             | 47     | 3      | namecheap        |
